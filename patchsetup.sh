...
patches_path="$build_root/device/motorola/falcon/patch/"
...
#sh device/motorola/falcon/update-overlay.sh
#rm -f out/target/product/falcon/system/build.prop out/target/product/falcon/boot/root/default.prop out/target/product/falcon/recovery/root/default.prop

echo "Checkout branches"
#sh device/motorola/falcon/update-repos.sh
